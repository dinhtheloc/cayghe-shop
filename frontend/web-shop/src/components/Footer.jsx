...
function Footer(props) {
    return (
        <footer className="footer py-8 pt-md-11 bg-dark mt-12">
                ...
                <div className="row">
                    ...
                    <div className="col-6 col-md">
                        ...
                        <ul className="list-unstyled">
                            ...
                            <li className="mb-3">
                                <a className="text-white-60" href="#!">Press</a>
                            </li>
                            <li>
                                <a className="text-white-60" href="#!">About us</a>
                            </li>
                        </ul>
                    ...
                    <div className="col-6 col-md">
                        ...
                        <ul className="list-unstyled">
                            <li className="mb-3">
                                <a className="text-white-60" href="#!">Homepage</a>
                            </li>
                            <li className="mb-3">
                                <a className="text-white-60" href="#!">Pages</a>
                            </li>
                            <li className="mb-3">
                                <a className="text-white-60" href="#!">Legal</a>
                            </li>
                            <li>
                                <a className="text-white-60" href="#!">Terms</a>
                            </li>
                        </ul>
                ...
                <div className="row align-items-center">
                    <div className="col-12 col-md">
                        ...
                        <ul className="list-inline list-unstyled text-gray-600 small mb-md-0">
                            ...
                            <li className="list-inline-item ml-md-8">
