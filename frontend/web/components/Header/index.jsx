function Header() {
    return (
        <nav className="navbar navbar-expand-lg navbar-light bg-light-boxed-right">
            <div className="container-lg">

                {/* <!-- Brand --> */}
                <a className="navbar-brand d-lg-none" href="./index.html">Xing Beauty</a>
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                                            ...
                                            <div className="dropdown-menu-footer align-items-center d-none d-lg-flex">
                                                ...
                                                <form className="ml-auto mr-n3">
                                                    <div className="custom-control custom-switch">
                                                        <input type="checkbox" className="custom-control-input family-switch" id="familySwitch"/>
                                                        <label className="custom-control-label" htmlFor="familySwitch"></label>
                                                    </div>
                                                </form>
                    ...
                    {/* <!-- Brand --> */}
                    <a className="navbar-brand d-none d-lg-block px-lg-6" href="./index.html">Xing Beauty</a>
                    ...
                    <ul className="navbar-nav justify-content-start w-100">
                        ...
                        <li className="nav-item d-lg-none">
                            <div className="nav-link">
                                ...
                                <form className="ml-auto mr-n3">
                                    <div className="custom-control custom-switch">
                                        <input type="checkbox" className="custom-control-input family-switch" id="familySwitchMobile" />
                                        <label className="custom-control-label" htmlFor="familySwitchMobile"></label>
                                    </div>
                                </form>
