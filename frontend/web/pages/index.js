...
export default function Home() {
  return (
    <>
      ...
      {/* <!-- TESTIMONIALS --> */}
      <section class="pt-10 pt-md-12 pb-9 pb-md-11 bg-light">
        <div class="container-lg">
          <div class="row justify-content-center mt-n8">
            <div class="col-md-6 px-lg-9 border-right-md">

              {/* <!-- Blockquote --> */}
              <blockquote class="mt-8">

                {/* <!-- Logo --> */}
                <p class="img-fluid svg-shim text-stripe mx-auto mb-3 mb-md-5" style={{maxWidth: "85px"}}>
                ...
                {/* <!-- Text --> */}
                <p class="lead text-center mb-5 mb-md-8">
                  <q>
            ...
            <div class="col-md-6 px-lg-9">
              ...
              <blockquote class="mt-8">
                ...
                {/* <!-- Logo --> */}
                <p class="img-fluid svg-shim text-pinterest mx-auto mb-3 mb-md-5" style={{maxWidth: "132px"}}>
                ...
                <div class="d-flex align-items-center justify-content-center">
                  ...
                  {/* <!-- Avatar --> */}
                  <div class="avatar avatar-sm">
                    <img class="avatar-img rounded-circle" src="assets/img/avatars/avatar-2.jpg" alt="..." />
                  </div>
        ...
        <div class="container-lg">
          <div class="row align-items-center justify-content-between">
            <div class="col-md-6">
              ...
              {/* <!-- Image --> */}
              <img class="img-fluid mb-8 mb-md-0" src="assets/img/e-commerce/product.jpg" alt="..." />
            ...
            <div class="col-md-6 col-lg-5">
              ...
              <h2 class="display-4 mb-4">
                Begin earning from your very first day
            </h2>
              ...
              <a class="h6 text-uppercase text-decoration-none" href="#!">
                Explore our tools <i class="fe fe-arrow-right ml-2"></i>
              </a>
          ...
          <div class="row align-items-center justify-content-between">
            <div class="col-md-5 order-md-1 pt-10 py-md-8">
              ...
              <div class="position-relative">
                ...
                {/* <!-- Image --> */}
                <img class="img-fluid position-relative border border-7 border-white shadow-lg" src="assets/img/e-commerce/customer.jpg" alt="..." />
            ...
            <div class="col-md-6 col-lg-5 order-md-0 py-10 py-md-12">
              ...
              {/* <!-- Heading --> */}
              <h2 class="display-4 mb-4">
                Market your store across all channels.
            </h2>
      ...
      {/* <!-- CASES --> */}
      <section class="pt-12 pt-md-18 pb-11 pb-md-16 bg-dark" style={{backgroundImage : 'url(assets/img/patterns/pattern-1.svg)'}}>
          ...
          <div class="row justify-content-center">
            <div class="col-md-10 col-lg-8 text-center">
              ...
              <h2 class="display-4 text-white mb-9">
                Our mobile app makes it dead simple to <span class="text-underline-primary-light">run your entire shop</span>.
            </h2>
        ...
        <div class="flickity-items-fade" data-flickity='{"imagesLoaded": true, "pageDots": false, "wrapAround": true}'>
          <div style={{
            ...
            {/* <!-- Image --> */}
            <img class="img-fluid rounded" src="assets/img/screenshots/mobile/screenshot-1.jpg" alt="..." />
          ...
          <div style={{
            ...
            {/* <!-- Image --> */}
            <img class="img-fluid rounded" src="assets/img/screenshots/mobile/screenshot-2.jpg" alt="..." />
          ...
          <div style={{
            ...
            {/* <!-- Image --> */}
            <img class="img-fluid rounded" src="assets/img/screenshots/mobile/screenshot-4.jpg" alt="..." />
          ...
          <div style={{
            ...
            {/* <!-- Image --> */}
            <img class="img-fluid rounded" src="assets/img/screenshots/mobile/screenshot-5.jpg" alt="..." />
          ...
          <div style={{
            ...
            {/* <!-- Image --> */}
            <img class="img-fluid rounded" src="assets/img/screenshots/mobile/screenshot-6.jpg" alt="..." />
          ...
          <div style={{
            ...
            {/* <!-- Image --> */}
            <img class="img-fluid rounded" src="assets/img/screenshots/mobile/screenshot-7.jpg" alt="..." />
          ...
          <div class="container-lg">
            <div class="row">
              <div class="col-md-8 col-lg-6">
                ...
                {/* <!-- Heading --> */}
                <h2 class="display-4 mb-4">
                  Customer service reps to keep sales up <span class="text-underline-warning">every day</span>.
              </h2>

                {/* <!-- Text --> */}
                <p class="font-size-lg text-muted">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. In urna lectus, mattis non accumsan in, tempor dictum.
              </p>
                ...
                <div class="row mx-md-n6 mb-8 mb-md-0">
                  ...
                  <div class="col-auto px-md-6 border-right">
                    ...
                    {/* <!-- Heading --> */}
                    <div class="h1 mb-0">
                      <span data-countup data-from="0" data-to="24" data-aos data-aos-id="countup:in">0</span>/<span data-countup data-from="0" data-to="7" data-aos data-aos-id="countup:in">0</span>
                    </div>
                  ...
                  <div class="col-auto px-md-6">
                    ...
                    {/* <!-- Heading --> */}
                    <div class="h1 mb-0">
                      <span data-countup data-from="0" data-to="42.3" data-decimals="1" data-aos data-aos-id="countup:in">0</span>%
                  </div>
              ...
              <div class="col-12">
                ...
                <div class="img-grid img-grid-3">
                  <div class="img-grid-item">
                    ...
                    {/* <!-- Image --> */}
                    <img class="img-fluid border border-4 border-md-7 border-white shadow" src="assets/img/e-commerce/customer-service-2.jpg" alt="..." data-jarallax-element="-65" />
                  ...
                  <div class="img-grid-item">
                    ...
                    {/* <!-- Card --> */}
                    <div class="card rounded-top-left rounded-bottom-right">

                      {/* <!-- Image --> */}
                      <img class="card-img-top rounded-top-left" src="assets/img/e-commerce/customer-service-4.jpg" alt="..." />

                      {/* <!-- SHAPE --> */}
                      <div class="position-relative">
                        <div class="shape shape-fluid-x shape-top text-white">
                          <div class="shape-img pb-6">
                      ...
                      <div class="card-body">
                        ...
                        <blockquote class="text-center mb-0">
                          ...
                          <p class="font-size-lg">
                            <strong class="text-primary text-underline-primary">Our mission</strong> is to help you run your store as efficiently as possible without incurring any costs.
                        </p>
